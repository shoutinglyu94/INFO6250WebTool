...
class PhoneNumber implements Serializable {
    ...
    public boolean equals(Object num) {
        ...
        if (num == null || !num.getClass().equals(this.getClass())) {
            return false;
        }
        PhoneNumber phoneNum = (PhoneNumber) num;
        return phoneNum.areacode.equals(this.areacode)&&phoneNum.number.equals(this.number);
    }
